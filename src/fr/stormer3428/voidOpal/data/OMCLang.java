...
public enum OMCLang {
	...
	public static void loadFromConfig() {
		File lang = new File(OMCPlugin.getJavaPlugin().getDataFolder(), "lang.yml");
		...
		if(!lang.exists()) try {
			...
			OMCPlugin.getJavaPlugin().getServer().getPluginManager().disablePlugin(OMCPlugin.getJavaPlugin());
		}
