...
public class OMCLogger {
	...
	@OMCKeep public static void setPrefixCommand(String prefix) {PREFIX_COMMAND = prefix;}
	@OMCKeep public static void setPrefixError(String prefix) {PREFIX_ERROR = prefix;}
